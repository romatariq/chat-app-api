...
public interface ICommentRepositoryCustom<TEntity>
{
    ...
    Task<(IEnumerable<TEntity> data, int pageCount)> GetAll(Guid groupId, Guid userId, string domain, string? path, string? parameters, ESort sort, int pageNr, int pageSize);
}